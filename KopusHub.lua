--[[
    ...
    Blue X Hub tarzı GUI | Stabil | Security Kick YOK
--]]
...
SendNotif("KopusHub v5.0", "Script yüklendi! Insert ile GUI açılır.")
print("========================================")
print("🔥 KOPUSHUB v5.0 YÜKLENDİ!")
print("✅ Auto Farm + Uçuş Birleşti")
print("✅ Security Kick YOK (Yavaş Hareket)")
